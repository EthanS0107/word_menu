    ...
    <PageTransition className="min-h-screen font-sans text-gray-800 bg-white overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[90vh] flex flex-col md:flex-row bg-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <motion.div 
            initial={{ x: '100%' }} animate={{ x: 0 }} transition={{ duration: 1, delay: 0.2 }}
            className="absolute top-0 right-0 w-[70%] h-full bg-[#D12421] origin-bottom-left skew-x-12 opacity-90">
          </motion.div> {/* Red */}
          
          <motion.div 
             initial={{ opacity: 0 }} animate={{ opacity: 0.9 }} transition={{ duration: 1, delay: 0.5 }}
          ...
          <motion.div 
             ...
             className="absolute bottom-0 w-full h-37.5 bg-[#007A3D]">
          </motion.div> {/* Green */}
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-12 flex flex-col md:flex-row items-center h-full">
          ...
          <div className="w-full md:w-1/2 p-8 bg-white/90 rounded-[40px] shadow-xl backdrop-blur-sm md:mr-8 mb-8 md:mb-0">
            ...
            >
              Laissez-vous porter par les saveurs ensoleillées des Seychelles, là où l'océan rencontre l'excellence culinaire.
            </motion.p>
          </div>

          {/* Images Grid (Mockup) */}
          <div className="w-full md:w-1/2 flex flex-wrap gap-4 h-125">
        ...
        <div className="container mx-auto relative z-10 flex flex-col md:flex-row items-center max-w-6xl">
           <SectionReveal className="w-full md:w-2/3">
             <div className="bg-white p-10 md:p-16 rounded-[50px] shadow-2xl relative">
                <h2 className="text-4xl font-bold mb-6 text-gray-900 border-l-8 border-[#FCD856] pl-4">Les Seychelles</h2>
                <p className="text-lg leading-relaxed font-semibold text-gray-800">
                  ...
                  Colonises par la France puis par le Royaume-Uni, elles deviennent indépendantes en 1976. 
                  Après une période de régime à parti unique, la démocratie est rétablie en 1993. 
                  Aujourd’hui, le pays est stable et doté d’institutions démocratiques solides, 
                  et son économie repose principalement sur le tourisme, la pêche et la protection de l’environnement.
                </p>
             </div>
           </SectionReveal>
      ...
      <section className="relative py-24 bg-[#003D88] text-white overflow-hidden">
        {/* Diagonal Slashes */}
        <div className="absolute top-0 right-0 w-[70%] h-full bg-[#D12421] transform -skew-x-20 origin-top-right"></div>
        <div className="absolute top-0 left-[20%] w-[30%] h-full bg-[#FCD856] transform -skew-x-20 opacity-100"></div>

        <div className="container mx-auto px-4 relative z-10">
          <SectionReveal>
             <h2 className="text-6xl font-black mb-16 text-left drop-shadow-md font-sans">MENU</h2>
          </SectionReveal>
              ...
              >
                <div className="w-48 h-48 mx-auto -mt-12 mb-6 rounded-full border-4 border-white shadow-lg bg-gray-200 overflow-hidden relative z-10">
                  <motion.img 
                    ...
                    src="/salade_de_fruits_tropicaux.jpeg" alt="Salade de palmiste" className="w-full h-full object-cover"
                  />
                </div>
                ...
                <div className="font-bold text-sm md:text-base px-2">
                  ...
                  <p className="leading-snug">
                     Coeur de palmier croquant, légumes frais nappés d'une vinaigrette délicates aux notes citronnées.
                  </p>
                </div>
              </motion.div>
            </SectionReveal>
            ...
            <SectionReveal delay={0.4}>
              ...
              >
                 <div className="w-48 h-48 mx-auto -mt-12 mb-6 rounded-full border-4 border-white shadow-lg bg-gray-200 overflow-hidden relative z-10">
                  <motion.img 
                    whileHover={{ scale: 1.1 }} transition={{ duration: 0.5 }}
                    src="/chutney_de_requin.webp" alt="Chutney de requin" className="w-full h-full object-cover"
                  />
                </div>
                ...
                <div className="font-bold text-sm md:text-base px-2">
                  ...
                  <p className="leading-snug">
                     A base de requin tendre, mijoté avec oignons, ail, gingembre, tomates, épices locales et une touche de piment.
                  </p>
                </div>
              </motion.div>
            </SectionReveal>
            ...
            <SectionReveal delay={0.6}>
              ...
              >
                 <div className="w-48 h-48 mx-auto -mt-12 mb-6 rounded-full border-4 border-white shadow-lg bg-gray-200 overflow-hidden relative z-10">
                  <motion.img 
                    whileHover={{ scale: 1.1 }} transition={{ duration: 0.5 }}
                    src="/le_ladob.jpg" alt="Le Ladob" className="w-full h-full object-cover"
                  />
                </div>
                ...
                <div className="font-bold text-sm md:text-base px-2">
                  ...
                  <p className="leading-snug">
                     Banane et patates douces cuits dans du lait de coco parfumé à la vanille, subtilement sucré et réconfortant.
                  </p>
                </div>
              </motion.div>
            </SectionReveal>
      ...
      {/* --- SECTION 4: DRINKS --- */}
      <section className="relative py-24 min-h-150 flex items-center bg-white overflow-hidden">
        {/* Circle background */}
        <motion.div 
           animate={{ scale: [1, 1.05, 1], rotate: [0, 5, 0] }} transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }}
        ...
        <div className="container mx-auto px-4 z-10 flex flex-col md:flex-row items-center">
          ...
          <SectionReveal className="w-full md:w-1/2 mb-10 md:mb-0 relative">
             <div className="w-64 md:w-80 h-125 mx-auto bg-gray-200 rounded-2xl shadow-2xl overflow-hidden border-8 border-white bg-[url('/seychelles_plage_2.webp')] bg-cover bg-center relative z-10"></div>
             {/* Decor */}
             <motion.div 
               animate={{ opacity: [0.3, 0.6, 0.3], scale: [1, 1.2, 1] }} transition={{ duration: 3, repeat: Infinity }}
          ...
          <div className="w-full md:w-1/2 text-center md:text-left pl-8">
            <SectionReveal delay={0.2}>
              <h2 className="text-5xl md:text-6xl font-black mb-8 text-black" style={{fontFamily: 'cursive, sans-serif'}}>
                JUS DES SEYCHELLES
              </h2>
              <p className="text-xl font-black uppercase leading-relaxed text-black/80 max-w-md">
                Fruits tropicaux frais pressés à la main, un véritable goût d'île dans chaque gorgée.
              </p>
            </SectionReveal>
          </div>
        </div>
